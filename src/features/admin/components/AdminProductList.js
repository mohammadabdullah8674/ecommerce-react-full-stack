...
export default function AdminProductList() {
  ...
  const handleFilter = (e, section, option) => {
    ...
    if (e.target.checked) {
      ...
      let index = newFilter[section.id].findIndex((elem) => elem == option.value)
  ...
  useEffect(() => {
    ...
    dispatch(fetchProductsByFiltersAsync({ sort, filter, pagination }));
    ...
    <>
      <div className="lg:col-span-3">
        ...
        <div className='flex justify-start '>
                <Link to="/admin/product-form" className="rounded-md mx-8 mt-2 bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-1 focus-visible:outline-offset-1 focus-visible:outline-indigo-600"
          ...
          <div className="mx-auto max-w-2xl px-4 py-0 sm:px-6 sm:py-0 lg:max-w-7xl lg:px-8">
            <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
              {products.map((product) => (
                ...
                <div className='mt-4'>
                <Link to={`/admin/product-form/edit/${product.id}`} className="rounded-md mt-4  bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                  >Edit Product</Link>
                </div>
                </div>
              ))}
        ...
        <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
          <div>
            <p className="text-sm text-gray-700">
              ...
              <span className="font-medium">
                {totalItems > page * ITEM_PER_PAGE ? page * ITEM_PER_PAGE : totalItems}
              </span> of{' '}
          ...
          <div>
            ...
            >
              ...
              {
                Array.from(Array(totalPages)).map((e, index) => {
                  return (<div
                    onClick={() => handlePage(index + 1)}
                    className={index + 1 == page ? "relative cursor-pointer z-10 inline-flex items-center bg-indigo-600 px-4 py-2 text-sm font-semibold text-white focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600" : "relative cursor-pointer inline-flex items-center px-4 py-2 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0"}
                  >
                    {index + 1}
                  </div>)
                })
